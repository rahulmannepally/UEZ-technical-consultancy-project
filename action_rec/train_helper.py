...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  9 03:29:55 2021
...
def training(model, num_epochs, train_set, dev_set, lr=1e-3, batch_size=32,
          start_epoch=1, log=20, checkpoint_path=None, validate=True,
